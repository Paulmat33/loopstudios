  ...
  return (
    <section className="bg-hero-sm bg-cover bg-no-repeat bg-grey ">
      ...
      <div className='pl-[24px] pb-[227px] '>
        <h1 className='border-2 w-[327px] text-[40px] font-light leading-[38px] text-grey py-[26px] px-[24px] font-josefinSans uppercase'>Immersive experiences that deliver</h1>
      </div>
    </section>
  )
}
